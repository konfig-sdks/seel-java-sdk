...
public class ProductAddNewProductRequest {
  ...
  public ProductAddNewProductRequest() {
  }

  public ProductAddNewProductRequest merchantId(String merchantId) {
  ...
  **/
  ...
  public ProductAddNewProductRequest variantId(String variantId) {
  ...
  **/
  ...
  public ProductAddNewProductRequest productId(String productId) {
  ...
  **/
  ...
  public ProductAddNewProductRequest productTitle(String productTitle) {
  ...
  **/
  ...
  public ProductAddNewProductRequest variantTitle(String variantTitle) {
  ...
  **/
  ...
  public ProductAddNewProductRequest brandName(String brandName) {
  ...
  **/
  ...
  public ProductAddNewProductRequest manufacturer(String manufacturer) {
  ...
  **/
  ...
  public ProductAddNewProductRequest category1(String category1) {
  ...
  **/
  ...
  public ProductAddNewProductRequest category2(String category2) {
  ...
  **/
  ...
  public ProductAddNewProductRequest category3(String category3) {
  ...
  **/
  ...
  public ProductAddNewProductRequest category4(String category4) {
  ...
  **/
  ...
  public ProductAddNewProductRequest productDescription(String productDescription) {
  ...
  **/
  ...
  public ProductAddNewProductRequest imageUrl(URI imageUrl) {
  ...
  **/
  ...
  public ProductAddNewProductRequest price(Double price) {
  ...
  **/
  ...
  public ProductAddNewProductRequest currency(String currency) {
  ...
  **/
  ...
  public ProductAddNewProductRequest requiresShipping(Boolean requiresShipping) {
  ...
  **/
  ...
  public ProductAddNewProductRequest modelNumber(String modelNumber) {
  ...
  **/
  ...
  public ProductAddNewProductRequest condition(String condition) {
  ...
  **/
  ...
  public ProductAddNewProductRequest sku(String sku) {
  ...
  **/
  ...
  public ProductAddNewProductRequest identifiers(ProductAddNewProductRequestIdentifiers identifiers) {
  ...
  **/
  ...
  public ProductAddNewProductRequestIdentifiers getIdentifiers() {
    return identifiers;
  }


  public void setIdentifiers(ProductAddNewProductRequestIdentifiers identifiers) {
  ...
  public ProductAddNewProductRequest manufacturerWarranty(ProductAddNewProductRequestManufacturerWarranty manufacturerWarranty) {
  ...
  **/
  ...
  public ProductAddNewProductRequestManufacturerWarranty getManufacturerWarranty() {
    return manufacturerWarranty;
  }


  public void setManufacturerWarranty(ProductAddNewProductRequestManufacturerWarranty manufacturerWarranty) {
  ...
  public ProductAddNewProductRequest dimensions(ProductAddNewProductRequestDimensions dimensions) {
  ...
  **/
  ...
  public ProductAddNewProductRequestDimensions getDimensions() {
    return dimensions;
  }


  public void setDimensions(ProductAddNewProductRequestDimensions dimensions) {
  ...
  public ProductAddNewProductRequest weight(ProductAddNewProductRequestWeight weight) {
  ...
  **/
  ...
  public ProductAddNewProductRequestWeight getWeight() {
    return weight;
  }


  public void setWeight(ProductAddNewProductRequestWeight weight) {
  ...
  public ProductAddNewProductRequest productAttributes(ProductAddNewProductRequestProductAttributes productAttributes) {
  ...
  **/
  ...
  public ProductAddNewProductRequestProductAttributes getProductAttributes() {
    return productAttributes;
  }


  public void setProductAttributes(ProductAddNewProductRequestProductAttributes productAttributes) {
  ...
  public ProductAddNewProductRequest createdTs(OffsetDateTime createdTs) {
  ...
  **/
  ...
  public ProductAddNewProductRequest updatedTs(OffsetDateTime updatedTs) {
  ...
  **/
   ...
   * @return the ProductAddNewProductRequest instance itself
   */
  public ProductAddNewProductRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductAddNewProductRequest productAddNewProductRequest = (ProductAddNewProductRequest) o;
    return Objects.equals(this.merchantId, productAddNewProductRequest.merchantId) &&
        Objects.equals(this.variantId, productAddNewProductRequest.variantId) &&
        Objects.equals(this.productId, productAddNewProductRequest.productId) &&
        Objects.equals(this.productTitle, productAddNewProductRequest.productTitle) &&
        Objects.equals(this.variantTitle, productAddNewProductRequest.variantTitle) &&
        Objects.equals(this.brandName, productAddNewProductRequest.brandName) &&
        Objects.equals(this.manufacturer, productAddNewProductRequest.manufacturer) &&
        Objects.equals(this.category1, productAddNewProductRequest.category1) &&
        Objects.equals(this.category2, productAddNewProductRequest.category2) &&
        Objects.equals(this.category3, productAddNewProductRequest.category3) &&
        Objects.equals(this.category4, productAddNewProductRequest.category4) &&
        Objects.equals(this.productDescription, productAddNewProductRequest.productDescription) &&
        Objects.equals(this.imageUrl, productAddNewProductRequest.imageUrl) &&
        Objects.equals(this.price, productAddNewProductRequest.price) &&
        Objects.equals(this.currency, productAddNewProductRequest.currency) &&
        Objects.equals(this.requiresShipping, productAddNewProductRequest.requiresShipping) &&
        Objects.equals(this.modelNumber, productAddNewProductRequest.modelNumber) &&
        Objects.equals(this.condition, productAddNewProductRequest.condition) &&
        Objects.equals(this.sku, productAddNewProductRequest.sku) &&
        Objects.equals(this.identifiers, productAddNewProductRequest.identifiers) &&
        Objects.equals(this.manufacturerWarranty, productAddNewProductRequest.manufacturerWarranty) &&
        Objects.equals(this.dimensions, productAddNewProductRequest.dimensions) &&
        Objects.equals(this.weight, productAddNewProductRequest.weight) &&
        Objects.equals(this.productAttributes, productAddNewProductRequest.productAttributes) &&
        Objects.equals(this.createdTs, productAddNewProductRequest.createdTs) &&
        Objects.equals(this.updatedTs, productAddNewProductRequest.updatedTs)&&
        Objects.equals(this.additionalProperties, productAddNewProductRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAddNewProductRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductAddNewProductRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductAddNewProductRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductAddNewProductRequest is not found in the empty JSON string", ProductAddNewProductRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProductAddNewProductRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("identifiers") != null && !jsonObj.get("identifiers").isJsonNull()) {
        ProductAddNewProductRequestIdentifiers.validateJsonObject(jsonObj.getAsJsonObject("identifiers"));
      }
      ...
      if (jsonObj.get("manufacturer_warranty") != null && !jsonObj.get("manufacturer_warranty").isJsonNull()) {
        ProductAddNewProductRequestManufacturerWarranty.validateJsonObject(jsonObj.getAsJsonObject("manufacturer_warranty"));
      }
      // validate the optional field `dimensions`
      if (jsonObj.get("dimensions") != null && !jsonObj.get("dimensions").isJsonNull()) {
        ProductAddNewProductRequestDimensions.validateJsonObject(jsonObj.getAsJsonObject("dimensions"));
      }
      // validate the optional field `weight`
      if (jsonObj.get("weight") != null && !jsonObj.get("weight").isJsonNull()) {
        ProductAddNewProductRequestWeight.validateJsonObject(jsonObj.getAsJsonObject("weight"));
      }
      ...
      if (jsonObj.get("product_attributes") != null && !jsonObj.get("product_attributes").isJsonNull()) {
        ProductAddNewProductRequestProductAttributes.validateJsonObject(jsonObj.getAsJsonObject("product_attributes"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductAddNewProductRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductAddNewProductRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductAddNewProductRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductAddNewProductRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductAddNewProductRequest>() {
           @Override
           public void write(JsonWriter out, ProductAddNewProductRequest value) throws IOException {
           ...
           @Override
           public ProductAddNewProductRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductAddNewProductRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductAddNewProductRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductAddNewProductRequest
  * @throws IOException if the JSON string is invalid with respect to ProductAddNewProductRequest
  */
  public static ProductAddNewProductRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductAddNewProductRequest.class);
  }

 /**
  * Convert an instance of ProductAddNewProductRequest to an JSON string
  *
  * @return JSON string
  */
